...
var myHandlers = {
    LaunchRequest: function(state) {
        if (this.handler.state == START) {
...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        's': {
            ...
            var message = 'Welcome to the Gimlet Skill. You can say, play the latest Surprisingly Awesome to begin.';
            var reprompt = 'You can say, play the latest Surprisingly Awesome to begin.';
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'I get by with a little help from my friends.';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. SM';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'PlayLatest' : function () { controller.play.call(this) },
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. PM';
            this.emit(':responseReady');
        }
    }),
